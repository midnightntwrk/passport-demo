...
| Security → Allowed Origins | **Origins** | `http://localhost:5175` (the dev origin this app pins itself to), `http://localhost:4173` (the Playwright preview origin), and the staging deployment's origin. A missing origin fails silently. |
