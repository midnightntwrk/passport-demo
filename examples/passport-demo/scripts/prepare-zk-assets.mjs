 ...
 *
 * `account-k1` is the k1-arm reference build, and it is the third case:
 * `assets: 'when-present'`. It DOES bring its own artefacts — thirty circuits
...
const CONTRACTS = [
  ...
  { name: 'account-k1', assets: 'when-present' },
