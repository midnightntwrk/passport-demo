 ...
 * the custody layer takes the curve arithmetic from the contract's own exported pure
 ...
 * custody layer and the conversion stays in `custodyContractSigning.ts`'s
