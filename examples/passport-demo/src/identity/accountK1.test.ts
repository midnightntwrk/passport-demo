/**
 * The k1 custody layer, drilled directly.
 *
 ...
 * The design doc records that, and the reason `src/identity/accountK1.ts`
 ...
 */
function fakePureCircuits(): K1PureCircuits & { calls: unknown[][] } {
  const calls: unknown[][] = [];
