/**
 * The client-side custody layer for the k1-arm reference account contract —
 ...
 * `docs/demo/k1-custody-layer-design.md` for the shape of that wiring and the
 ...
 *    takes a {@link K1PureCircuits} as its first argument instead of reaching
 *    for a compiled contract module. The compiled `account-k1` build is ~100 MB
 ...
 * {@link K1PureCircuits} without a cast at the call site.
 */
 ...
 *
 * TODO(k1-custody, PR 2): supply the real object. It comes from the compiled
 * `account-k1` module, loaded the way `contractRuntime.ts` loads the other
 * contract modules — from the staged `contracts/stagenet/managed/account-k1/`
 ...
 */
export interface K1PureCircuits {
