 ...
 *
 * `src/identity/k1Inbox.ts` went IN on 2026/09/16 with the module itself, and
 ...
 * that would open as nonsense, and all three are drilled in `k1Inbox.test.ts`
