...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      mint_shielded: async (...args_1) => {
        if (args_1.length !== 5) {
          throw new __compactRuntime.CompactError(`mint_shielded: expected 5 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(color_0).concat(_descriptor_7.toValue(amount_0).concat(_descriptor_0.toValue(nonce_0).concat(_descriptor_4.toValue(recipient_0)))),
            alignment: _descriptor_0.alignment().concat(_descriptor_7.alignment().concat(_descriptor_0.alignment().concat(_descriptor_4.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
        };
        const result_0 = await this._mint_shielded_0(context,
                                                     partialProofData,
                                                     color_0,
                                                     amount_0,
                                                     nonce_0,
    ...
    this.impureCircuits = { mint_shielded: this.circuits.mint_shielded };
    this.provableCircuits = { mint_shielded: this.circuits.mint_shielded };
  }
  ...
  async _mint_shielded_0(context,
                         partialProofData,
                         color_0,
                         amount_0,
                         nonce_0,
...
export const expectedVk = {
  'mint_shielded': '6c77d49f22bc7479f39d46458c3de9de8c3d498d553ba01e9861e0a730c8adac',
};
