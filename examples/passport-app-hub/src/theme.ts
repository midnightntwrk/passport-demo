/**
 * Hub theme preference — a compact sibling of the Passport app's own
 * the Passport app's theme module, using the same mechanism:
 *
...
export const THEME_STORAGE_KEY = 'passport-hub-theme';
